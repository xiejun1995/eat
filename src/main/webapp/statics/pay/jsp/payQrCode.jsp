...
<body>
	...
	<script src="${pageContext.request.contextPath}/statics/pay/js/jquery.min.js?v=1.0.1" type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/statics/pay/js/jquery-qrcode/jquery.qrcode.min.js?v=1.0.1" type="text/javascript"></script>
