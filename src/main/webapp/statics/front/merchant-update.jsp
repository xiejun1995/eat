			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 商家修改菜品信息</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<form class="form-horizontal" action="${pageContext.request.contextPath}/greens/updateGreensById" method="post" enctype="multipart/form-data">
							<fieldset>
								<div class="control-group">
									<label class="control-label" for="greensId" style="display:inline;">菜品ID : </label>
									<div class="input-group">
										<input type="text" name="greensId" class="form-control" id="greensId" style="display: inline;width: 200px" autocomplete="off"
											   required title="菜品名称不能为空" placeholder="请输入菜品名称" value="${eatGreens.greensId}" readonly>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="input-group">
										<input type="text" name="greensSecurityId" class="form-control" id="greensSecurityId" style="display: inline;width: 200px" autocomplete="off"
											   required title="菜品地址不能为空" placeholder="请输入菜品地址" value="${eatGreens.greensSecurityId}" readonly>
									</div>
									<div>
										<img src="${eatGreens.greensPic}" alt="">
									</div>
								</div>
								<%--LOGO上传功能开始--%>
								...
								<div class="form-actions">
									<button id="submit" type="submit" class="btn btn-primary">修改菜品信息</button>
								</div>
							</fieldset>
						</form>
					</div>
