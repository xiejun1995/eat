	...
	<body>
		...
		<div class="section">
			...
			<div class="container">
				...
				<div class="row">
					<%--使用spring表单：添加用户 --%>
						<fm:form modelAttribute="eatUser"
								 action="/user/doAddUser" method="post">
							<div class="col-md-7">
								<!-- Billing Details -->
								<div class="billing-details">
									...
									<div class="form-group">
										姓名：<fm:input class="input" path="userName"/> <fm:errors cssStyle="color: red" path="userName"/>
										<%--<input class="input" type="text" name="userName" placeholder="请输入姓名！"/>--%>
									</div>
									<div class="form-group">
										密码：<fm:input class="input" path="userPassword"/> <fm:errors cssStyle="color: red" path="userPassword"/>
										<%--<input class="input" type="text" name="userPassword" placeholder="请输入密码！"/>--%>
									</div>
									<div class="form-group">
										出生日期：<fm:input class="input" path="userBornDate"/> <fm:errors cssStyle="color: red" path="userBornDate"/>
										<%--<input class="input" type="date" name="userBornDate" placeholder="请输入出生日期！"/>--%>
									</div>
									<div class="form-group">
										电话号码：<fm:input class="input" path="userPhone"/> <fm:errors cssStyle="color: red" path="userPhone"/>
										<%--<input class="input" type="text" name="userPhone" placeholder="请输入电话号码！"/>--%>
									</div>
									<div class="form-group">
										地址：<fm:input class="input" path="userAddress"/> <fm:errors cssStyle="color: red" path="userAddress"/>
										<%--<input class="input" type="text" name="userAddress" placeholder="请输入地址！"/>--%>
									</div>
									<div class="form-group">
										邮箱：<fm:input class="input" path="userEmail"/> <fm:errors cssStyle="color: red" path="userEmail"/>
										<%--<input class="input" type="email" name="userEmail" placeholder="请输入邮箱！"/>--%>
									</div>
									<div class="form-group">
										性别：
