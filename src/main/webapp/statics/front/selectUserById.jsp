	...
	<body>
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">用户基本信息</h3>
					</div>
				</div>
				<!-- /row -->
			</div>
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								姓名：<input class="input" type="text" name="userName" value="${user.userName}"/>
							</div>
							<div class="form-group">
								密码：<input class="input" type="text" name="userPassword" value="${user.userPassword}"/>
							</div>
							<div class="form-group">
								出生日期：<input class="input" type="date" name="userBornDate" value="${user.userBornDate}"/>
							</div>
							<div class="form-group">
								电话号码：<input class="input" type="text" name="userPhone" value="${user.userPhone}"/>
							</div>
							<div class="form-group">
								地址：<input class="input" type="text" name="userAddress" value="${user.userAddress}"/>
							</div>
							<div class="form-group">
								邮箱：<input class="input" type="email" name="userEmail" value="${user.userEmail}"/>
							</div>
							<div class="form-group">
								性别：
