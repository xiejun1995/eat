			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> 商家信息列表</h2>
						<a class="btn btn-success" href="${pageContext.request.contextPath}/toAddMerchant" style="margin-left: 785px">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
							...
							<c:forEach items="${listMerchant}" var="merchant">
								<tr>
									...
									<td class="center">${merchant.merchantPhone}</td>
									<td class="center">${merchant.merchantAddress}</td>
									<td class="center">${merchant.merchantStatus}</td>
									<td class="center">${merchant.merchantEmail}</td>
									<td class="center">${merchant.merchantName}</td>
									<td class="center">${merchant.merchantSecurityId}</td>
									<td class="center">
										<a class="btn btn-info" href="${pageContext.request.contextPath}/toUpdateMerchant?merchantId=${merchant.merchantId}">
											<i class="icon-edit icon-white"></i>
											修改
										</a>
										<a class="btn btn-danger" href="${pageContext.request.contextPath}/deleteMerchant?merchantId=${merchant.merchantId}">
