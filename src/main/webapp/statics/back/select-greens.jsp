		...
		<div id="content" class="span10">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="javascript:history.go(-1)">菜品管理</a>
					</li>
				</ul>
			</div>
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
							...
							<c:forEach items="${list}" var="Greens">
								<tr>
									<td>${Greens.greensName}</td>
									<td class="center">${Greens.greensPrice}</td>
									<td class="center">${Greens.greensAddress}</td>
									<td class="center">${Greens.cuisineName}</td>
									<td class="center">${Greens.greensDetails}</td>
									<td class="center">
										<a class="btn btn-info" href="${pageContext.request.contextPath}/toUpdateGreens?greensId=${Greens.greensId}">
